...
export default function ElegantCard({ card, isMobile = false }: ElegantCardProps) {
    const { 
    ...
    return (
        <div style={{ minHeight: "100vh", background: `linear-gradient(180deg, ${primaryColor}08 0%, ${secondaryColor}05 100%)`, fontFamily: "'Georgia', 'Times New Roman', serif" }}>
            {/* View Counter */}
            {viewCount && (
                <div style={{ 
                    position: "sticky", 
