...
import { Phone, Mail, MapPin, Globe, Facebook, Instagram, Linkedin, Twitter, Youtube, Share2, MessageCircle, Star, Send, CreditCard, Image as ImageIcon, Video, Eye, QrCode, User, Briefcase, ShoppingBag, Wallet, Home } from "lucide-react";
...
END:VCARD`;
                ...
                {/* Footer Badge */}
                <div style={{ textAlign: "center", paddingBottom: "6rem", paddingTop: "1rem" }}>
                ...
                <div style={{
                    ...
                    <button
                        ...
                        style={{
                            ...
                            alignItems: "center",
                            padding: "0.5rem",
                            backgroundColor: activeSection === "profile" ? `${primaryColor}10` : "transparent",
                            border: "none",
                            borderRadius: "8px",
                            cursor: "pointer",
                            transition: "all 0.2s"
                    ...
                    >
                        <User size={20} color={activeSection === "profile" ? primaryColor : "#6b7280"} />
                        <span style={{ fontSize: "0.65rem", marginTop: "0.25rem", color: activeSection === "profile" ? primaryColor : "#6b7280", fontWeight: activeSection === "profile" ? "600" : "400" }}>Profile</span>
                    </button>
                    ...
                    {bio && (
                        <button
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                padding: "0.5rem",
                                backgroundColor: activeSection === "about" ? `${primaryColor}10` : "transparent",
                                border: "none",
                                borderRadius: "8px",
                                cursor: "pointer",
                                transition: "all 0.2s"
                        ...
                        >
                            <Home size={20} color={activeSection === "about" ? primaryColor : "#6b7280"} />
                            <span style={{ fontSize: "0.65rem", marginTop: "0.25rem", color: activeSection === "about" ? primaryColor : "#6b7280", fontWeight: activeSection === "about" ? "600" : "400" }}>About</span>
                        </button>
                    )}
                    ...
                    <button
                        ...
                        style={{
                            ...
                            alignItems: "center",
                            padding: "0.5rem",
                            backgroundColor: activeSection === "contact" ? `${primaryColor}10` : "transparent",
                            border: "none",
                            borderRadius: "8px",
                            cursor: "pointer",
                            transition: "all 0.2s"
                    ...
                    >
                        <Phone size={20} color={activeSection === "contact" ? primaryColor : "#6b7280"} />
                        <span style={{ fontSize: "0.65rem", marginTop: "0.25rem", color: activeSection === "contact" ? primaryColor : "#6b7280", fontWeight: activeSection === "contact" ? "600" : "400" }}>Contact</span>
                    </button>
                    ...
                    {specialities && specialities.length > 0 && (
                        <button
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                padding: "0.5rem",
                                backgroundColor: activeSection === "specialities" ? `${primaryColor}10` : "transparent",
                                border: "none",
                                borderRadius: "8px",
                                cursor: "pointer",
                                transition: "all 0.2s"
                        ...
                        >
                            <Briefcase size={20} color={activeSection === "specialities" ? primaryColor : "#6b7280"} />
                            <span style={{ fontSize: "0.65rem", marginTop: "0.25rem", color: activeSection === "specialities" ? primaryColor : "#6b7280", fontWeight: activeSection === "specialities" ? "600" : "400" }}>Services</span>
                        </button>
                    )}
                    ...
                    {enableProducts && products && products.length > 0 && (
                        <button
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                padding: "0.5rem",
                                backgroundColor: activeSection === "products" ? `${primaryColor}10` : "transparent",
                                border: "none",
                                borderRadius: "8px",
                                cursor: "pointer",
                                transition: "all 0.2s"
                        ...
                        >
                            <ShoppingBag size={20} color={activeSection === "products" ? primaryColor : "#6b7280"} />
                            <span style={{ fontSize: "0.65rem", marginTop: "0.25rem", color: activeSection === "products" ? primaryColor : "#6b7280", fontWeight: activeSection === "products" ? "600" : "400" }}>Products</span>
                        </button>
                    )}
                    ...
                    {enablePayment && payment && (
                        <button
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                padding: "0.5rem",
                                backgroundColor: activeSection === "payment" ? `${primaryColor}10` : "transparent",
                                border: "none",
                                borderRadius: "8px",
                                cursor: "pointer",
                                transition: "all 0.2s"
                        ...
                        >
                            <Wallet size={20} color={activeSection === "payment" ? primaryColor : "#6b7280"} />
                            <span style={{ fontSize: "0.65rem", marginTop: "0.25rem", color: activeSection === "payment" ? primaryColor : "#6b7280", fontWeight: activeSection === "payment" ? "600" : "400" }}>Payment</span>
                        </button>
                    )}
                    ...
                    {enableGallery && gallery && gallery.length > 0 && (
                        <button
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                padding: "0.5rem",
                                backgroundColor: activeSection === "gallery" ? `${primaryColor}10` : "transparent",
                                border: "none",
                                borderRadius: "8px",
                                cursor: "pointer",
                                transition: "all 0.2s"
                        ...
                        >
                            <ImageIcon size={20} color={activeSection === "gallery" ? primaryColor : "#6b7280"} />
                            <span style={{ fontSize: "0.65rem", marginTop: "0.25rem", color: activeSection === "gallery" ? primaryColor : "#6b7280", fontWeight: activeSection === "gallery" ? "600" : "400" }}>Gallery</span>
                        </button>
                    )}
                    ...
                    {videos && videos.length > 0 && (
                        <button
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                padding: "0.5rem",
                                backgroundColor: activeSection === "videos" ? `${primaryColor}10` : "transparent",
                                border: "none",
                                borderRadius: "8px",
                                cursor: "pointer",
                                transition: "all 0.2s"
                        ...
                        >
                            <Video size={20} color={activeSection === "videos" ? primaryColor : "#6b7280"} />
                            <span style={{ fontSize: "0.65rem", marginTop: "0.25rem", color: activeSection === "videos" ? primaryColor : "#6b7280", fontWeight: activeSection === "videos" ? "600" : "400" }}>Videos</span>
                        </button>
                    )}
                    ...
                    {enableFeedback && (
                        <button
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                padding: "0.5rem",
                                backgroundColor: activeSection === "feedback" ? `${primaryColor}10` : "transparent",
                                border: "none",
                                borderRadius: "8px",
                                cursor: "pointer",
                                transition: "all 0.2s"
                        ...
                        >
                            <Star size={20} color={activeSection === "feedback" ? primaryColor : "#6b7280"} />
                            <span style={{ fontSize: "0.65rem", marginTop: "0.25rem", color: activeSection === "feedback" ? primaryColor : "#6b7280", fontWeight: activeSection === "feedback" ? "600" : "400" }}>Feedback</span>
                        </button>
                    )}
                    ...
                    {enableContactForm && (
                        <button
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                padding: "0.5rem",
                                backgroundColor: activeSection === "enquiry" ? `${primaryColor}10` : "transparent",
                                border: "none",
                                borderRadius: "8px",
                                cursor: "pointer",
                                transition: "all 0.2s"
                        ...
                        >
                            <Send size={20} color={activeSection === "enquiry" ? primaryColor : "#6b7280"} />
                            <span style={{ fontSize: "0.65rem", marginTop: "0.25rem", color: activeSection === "enquiry" ? primaryColor : "#6b7280", fontWeight: activeSection === "enquiry" ? "600" : "400" }}>Enquiry</span>
                        </button>
                    )}
                    ...
                    <button
                        ...
                        style={{
                            ...
                            alignItems: "center",
                            padding: "0.5rem",
                            backgroundColor: activeSection === "share" ? `${primaryColor}10` : "transparent",
                            border: "none",
                            borderRadius: "8px",
                            cursor: "pointer",
                            transition: "all 0.2s"
                    ...
                    >
                        <Share2 size={20} color={activeSection === "share" ? primaryColor : "#6b7280"} />
                        <span style={{ fontSize: "0.65rem", marginTop: "0.25rem", color: activeSection === "share" ? primaryColor : "#6b7280", fontWeight: activeSection === "share" ? "600" : "400" }}>Share</span>
                    </button>
                </div>
            </div>
        </div>
