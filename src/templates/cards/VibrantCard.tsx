...
export default function VibrantCard({ card, isMobile = false }: VibrantCardProps) {
    const { 
    ...
    return (
        <div style={{ minHeight: "100vh", background: `linear-gradient(135deg, ${primaryColor}12 0%, ${secondaryColor}15 50%, ${primaryColor}10 100%)`, fontFamily: "'Inter', -apple-system, sans-serif" }}>
            {/* View Counter */}
            {viewCount && (
                <div style={{ 
                    position: "sticky", 
