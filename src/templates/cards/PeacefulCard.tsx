...
interface PeacefulCardProps {
    card: BusinessCard;
    isMobile?: boolean;
}

export default function PeacefulCard({ card, isMobile = false }: PeacefulCardProps) {
    const { 
    ...
    return (
        <div style={{ minHeight: "100vh", background: `linear-gradient(180deg, ${primaryColor}10 0%, ${secondaryColor}08 100%)`, fontFamily: "'Quicksand', 'Segoe UI', sans-serif" }}>
            {/* View Counter */}
            {viewCount && (
                <div style={{ 
                    position: "sticky", 
